        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#portfolio">Vote Now</a></li>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>Bettter digital experience with vote</h1>
                    <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti eius animi odio magni
                        architecto ullam necessitatibus provident explicabo rerum! Commodi id atque iusto, quasi totam
                        eos dolorem impedit voluptate numquam.</h2>
                    <div>
